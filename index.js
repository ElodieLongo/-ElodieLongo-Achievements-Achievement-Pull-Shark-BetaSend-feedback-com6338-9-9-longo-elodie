...
const [weatherElement, currentWeatherDescriptionElement, currentTempElement, feelsLikeTempElement, lastUpdatedTimeElement, searchButton] =
[`#weather`, `#weather p:first-child`, `#weather p:nth-of-type(2)`, `#weather p:nth-of-type(3)`, `#weather p:last-child`, `button[type="submit"]`].map(id => document.querySelector(id));
